  ...
  ${e.mainStart()}
    ...
    ${i.setByOffset("global_idx",r.getByIndices("aIndices"))}
       ...
       `,{name:n,shaderCache:{hint:`${s};${y}`,inputDependencies:["type"]},getShaderSource:e=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:d,dataType:l}],dispatchGroup:{x:h},programUniforms:[{type:12,data:f}]})}),{inputs:[x]})},tZ=(e,r)=>{tQ(e,"ReduceMeanShared",r,"mean")},tX=(e,r)=>{tQ(e,"ReduceL1Shared",r,"l1")},tY=(e,r)=>{tQ(e,"ReduceL2Shared",r,"l2")},tJ=(e,r)=>{tQ(e,"ReduceLogSumExpShared",r,"logSumExp")},t0=(e,r)=>{tQ(e,"ReduceMaxShared",r,"max")},t1=(e,r)=>{tQ(e,"ReduceMinShared",r,"min")},t2=(e,r)=>{tQ(e,"ReduceProdShared",r,"prod")},t3=(e,r)=>{tQ(e,"ReduceSumShared",r,"sum")},t4=(e,r)=>{tQ(e,"ReduceSumSquareShared",r,"sumSquare")},t6=(e,r)=>{tQ(e,"ReduceLogSumShared",r,"logSum")}}),nz=V(()=>{ng(),nb(),nS(),nT(),nE(),t8=e=>{if(!e||0===e.length||e.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===e.length&&1!==e[1].dims.length)throw Error("Invalid axes input dims.")},t5=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],t9=(e,r,i,a,n,s,o=!1,u=!1)=>{let l=[],d=i[0].dims,p=d.length,c=e6.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((e,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(e)});let f=l.length,m=e6.size(l);return{name:e,shaderCache:r,getShaderSource:e=>{let r=[],n=tM("_A",i[0].dataType,p),u=tN("output",s,f),l=a(n,u,c),m=l[2];for(let e=0,i=0;e<p;e++)h||c.indexOf(e)>=0?(o&&i++,m=`for(var j${e}: u32 = 0; j${e} < ${d[e]}; j${e}++) {
...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
    ...
    `,ry=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,k,S,T,I,E,z,C,A,O,R,B,M,N,D;let P,U,q,W,L,V,G,H,F,j,K,Q,Z,X,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?d.pastSequenceLength:0,eb=e_+d.kvSequenceLength,e$=l&&e6.size(l.dims)>0?l:void 0,ev=[r,i];ey>1&&o&&e6.size(o.dims)>0&&ev.push(o),e$&&ev.push(e$),p&&ev.push(p),c&&ev.push(c);let ew=e.compute((h=ey,f=r,m=i,g=o,y=e$,_=d,b=e_,$=p,v=c,P=b+_.kvSequenceLength,U=[_.batchSize,_.numHeads,_.sequenceLength,P],q=h>1&&g,W=_.kvNumHeads?_.kvNumHeads:_.numHeads,L=q?[_.batchSize,W,P,_.headSize]:void 0,V=_.nReps?_.nReps:1,G=0===_.scale?1/Math.sqrt(_.headSize):_.scale,H=tz(_.headSize),F=_.headSize/H,j={x:Math.ceil(P/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:F},{type:12,data:P},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:G},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Q=q&&g&&e6.size(g.dims)>0,Z=["type","type"],Q&&Z.push("type"),y&&Z.push("type"),$&&Z.push("type"),v&&Z.push("type"),X=[{dims:U,dataType:f.dataType,gpuDataType:0}],q&&X.push({dims:L,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${H};${void 0!==y};${void 0!==g};${h}`,inputDependencies:Z},getRunData:()=>({outputs:X,dispatchGroup:j,programUniforms:K}),getShaderSource:e=>{let r=tM("q",f.dataType,f.dims,H),i=[r,tM("key",m.dataType,m.dims,H)];if(Q){let e=tM("past_key",g.dataType,g.dims,H);i.push(e)}y&&i.push(tM("attention_bias",y.dataType,y.dims));let a=$?tM("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tM("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=tN("output",f.dataType,U),o=[s];q&&o.push(tN("present_key",f.dataType,L,H));let u=tI(1,H);return`
  const TILE_SIZE = 12u;
  ...
  }`},getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:T,z:x*k},programUniforms:et})}),{inputs:p&&c?[ew,p,c]:[ew],outputs:[]});let ex=[ew,a];ey>1&&u&&e6.size(u.dims)>0&&ex.push(u),p&&ex.push(p),c&&ex.push(c),e.compute((C=ey,A=ew,O=a,R=u,B=d,M=e_,N=p,D=c,en=M+B.kvSequenceLength,es=B.nReps?B.nReps:1,eo=B.vHiddenSize*es,eu=C>1&&R,el=B.kvNumHeads?B.kvNumHeads:B.numHeads,ed=eu?[B.batchSize,el,en,B.headSize]:void 0,ep=[B.batchSize,B.sequenceLength,eo],ec={x:Math.ceil(B.vHeadSize/12),y:Math.ceil(B.sequenceLength/12),z:B.batchSize*B.numHeads},eh=[{type:12,data:B.sequenceLength},{type:12,data:en},{type:12,data:B.vHeadSize},{type:12,data:B.numHeads},{type:12,data:B.headSize},{type:12,data:eo},{type:12,data:M},{type:12,data:B.kvSequenceLength},{type:12,data:es}],ef=eu&&R&&e6.size(R.dims)>0,em=["type","type"],ef&&em.push("type"),N&&em.push("type"),D&&em.push("type"),eg=[{dims:ep,dataType:A.dataType,gpuDataType:0}],eu&&eg.push({dims:ed,dataType:A.dataType,gpuDataType:0}),{name:"AttentionScore",shaderCache:{hint:`${void 0!==R};${C}`,inputDependencies:em},getRunData:()=>({outputs:eg,dispatchGroup:ec,programUniforms:eh}),getShaderSource:e=>{let r=tM("probs",A.dataType,A.dims),i=[r,tM("v",O.dataType,O.dims)];ef&&i.push(tM("past_value",R.dataType,R.dims));let a=N?tM("seq_lens",N.dataType,N.dims):void 0;N&&i.push(a);let n=D?tM("total_sequence_length_input",D.dataType,D.dims):void 0;D&&i.push(n);let s=[tN("output",A.dataType,ep)];return eu&&s.push(tN("present_value",A.dataType,ed)),`
  const TILE_SIZE = 12u;
...
}`,rP=e=>{let r=tI(e.inputs[0].dataType);e.compute(rv(e.inputs[0],"Erf",e=>`erf_vf32(${e})`,rD(r)))},rU=e=>{e.compute(rv(e.inputs[0],"Exp","exp"))},rq=e=>{e.compute(rv(e.inputs[0],"Floor","floor"))},rW=e=>{let r=tI(e.inputs[0].dataType);e.compute(rv(e.inputs[0],"Gelu",e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,rD(r)))},rL=(e,r)=>{let i=tI(e.inputs[0].dataType);e.compute(rv(e.inputs[0],"LeakyRelu",e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},rV=e=>{e.compute(rv(e.inputs[0],"Not",e=>`!${e}`))},rG=e=>{e.compute(rv(e.inputs[0],"Neg",e=>`-${e}`))},rH=e=>{e.compute(rv(e.inputs[0],"Reciprocal",e=>`1.0/${e}`))},rF=e=>{let r=tI(e.inputs[0].dataType);e.compute(rv(e.inputs[0],"Relu",e=>`select(vec4<${r}>(0.0), ${e}, ${e} > vec4<${r}>(0.0))`))},rj=e=>{e.compute(rv(e.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},rK=e=>tx(e),rQ=(e,r)=>{let i=tI(e.inputs[0].dataType);e.compute(rv(e.inputs[0],"HardSigmoid",e=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${e} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},rZ=e=>{e.compute(rv(e.inputs[0],"Sin","sin"))},rX=e=>{e.compute(rv(e.inputs[0],"Sinh","sinh"))},rY=e=>{e.compute(rv(e.inputs[0],"Sqrt","sqrt"))},rJ=e=>{e.compute(rv(e.inputs[0],"Tan","tan"))},r0=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,r1=e=>{e.compute(rv(e.inputs[0],"Tanh",r0))},r2=(e="f32")=>`
...
`),r.cacheKey,e.inputs[0].dataType))}}),nM=V(()=>{nb(),nT(),nB(),r7=e=>{var r;let i,a,n,s,o,u;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute(((i=(r=e.inputs)[0].dims.slice())[2]=i[2]/2,a=tM("input",r[0].dataType,r[0].dims,4),n=tM("bias",r[0].dataType,[r[0].dims[2]],4),s=tN("output",r[0].dataType,i,4),o=e6.size(i)/4,u=tT(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:e=>`
...
`)})(o,c)}
        ...
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},ig=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},iy=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},i_=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[e9,e7];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nU=V(()=>{ib=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},i$=e=>`
...
`)};
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),nJ=V(()=>{ng(),nb(),nT(),nB(),i9=e=>{var r;let i,a,n,s;e.inputs.length<2||0===e6.size(e.inputs[1].dims)?r4(e):e.compute((i=(r=e.inputs)[0].dataType,a=e6.size(r[0].dims),s=(n=e6.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tM("x",i,[1],4),a=tM("bias",i,[1],4),n=tN("y",i,[1],4),o=e=>`
    ...
    }`},getRunData:e=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],programUniforms:[{type:12,data:Math.ceil(a/4)},{type:12,data:n}],dispatchGroup:{x:Math.ceil(a/tk/4)}})}))}}),n0=V(()=>{ng(),nb(),nS(),nT(),i7=e=>tx({axis:e.axis}),ae=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h;(e=>{if(!e||2!==e.length)throw Error("Gather requires 2 inputs.")})(e.inputs),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=e6.normalizeAxis(a.axis,o),(l=n.slice(0)).splice(u,1,...s),d=n[u],p=9===i[0].dataType?4:1,h=[{type:12,data:c=Math.ceil(e6.size(l)/p)},{type:6,data:d},{type:12,data:u},...tE(i[0].dims,i[1].dims,l)],{name:"Gather",shaderCache:{hint:a.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:e=>{let r=tM("data",i[0].dataType,i[0].dims.length,p),a=tM("inputIndices",i[1].dataType,i[1].dims.length),n=tN("output",i[0].dataType,l.length,p),d=e=>{let i=s.length,n=`var indicesIndices${e}  = ${a.type.indices}(0);`;for(let r=0;r<i;r++)n+=`${i>1?`indicesIndices${e}[${r}]`:`indicesIndices${e}`} = ${l.length>1?`outputIndices${e}[uniforms.axis + ${r}]`:`outputIndices${e}`};`;n+=`
