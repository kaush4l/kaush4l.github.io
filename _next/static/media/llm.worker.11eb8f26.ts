import { AutoProcessor, env, TextStreamer, load_image, AutoModelForCausalLM, AutoModelForImageTextToText } from '@huggingface/transformers';
...
self.addEventListener('message', async (event)=>{
    ...
    if (type === 'load') {
        ...
        try {
            ...
            const decoded = pt.batch_decode(outputs.slice(null, [
